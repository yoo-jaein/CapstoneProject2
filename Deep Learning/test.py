...
# image_listener라는 이름으로 노드를 초기화한다
rospy.init_node('image_listener')

# 토픽 /raspicam_node/image/compressed이 들어오면 image_callback을 실행한다
